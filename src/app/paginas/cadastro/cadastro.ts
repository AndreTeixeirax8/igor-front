...
@Component({
  ...
  imports: [FormsModule, RouterLink, Logotipo, Mensagem, SeletorFoto],
...
export class Cadastro {
  ...
  /** Foto de perfil escolhida no seletor (opcional). */
    ...
    this.autenticacaoServico
      ...
      .subscribe({
        ...
        error: (erro: unknown) => {
          ...
          this.mensagemErro.set(
            mensagemDeErro(erro, 'Não foi possível criar a conta. Tente novamente.'),
          );
        },
      });
  }
